    ...
    >
      ...
      <div className="h-5/6 w-full flex flex-col justify-start items-start pl-12 text-lg">
        {options.map((option: string) => {
          return (
            <div className="border-2 border-solid text-white border-black my-2 px-4 py-2 rounded-lg min-w-[150px] cursor-pointer bg-blue-400 hover:bg-blue-500 transition-all ease-in-out duration-150">
